...
/* harmony import */ var _store_wishlistData__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(4994);
/* harmony import */ var _Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(6681);
/* harmony import */ var _Contexts_LoginContext__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(3591);
...
function LoginWidget({ redirect =true , loginActionPopup , notVerifyHandler  }) {
    ...
    const loginPopupBoard = (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(_Contexts_LoginContext__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .Z);
    const { 0: email , 1: setEmail  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("");
    const { 0: password , 1: setPassword  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("");
    const { 0: loading , 1: setLoading  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
    const { 0: checked , 1: setValue  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
    const { 0: errors , 1: setErrors  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
    const { 0: googleUrl , 1: setGoogleUrl  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
    const { 0: faceBookUrl , 1: setFaceBookUrl  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
    const rememberMe = ()=>{
        setValue(!checked);
    };
    const sendOtpHandler = ()=>{
        _utils_apiRequest__WEBPACK_IMPORTED_MODULE_5__/* ["default"].resend */ .Z.resend({
            email: email
        }).then(()=>{
    ...
    const doLogin = async ()=>{
        setLoading(true);
        await _utils_apiRequest__WEBPACK_IMPORTED_MODULE_5__/* ["default"].login */ .Z.login({
            email: email,
            password: password
        }).then((res)=>{
            setLoading(false);
            react_toastify__WEBPACK_IMPORTED_MODULE_4__.toast.success("Login Successfull");
            setEmail("");
            setPassword("");
            localStorage.removeItem("auth");
            localStorage.setItem("auth", JSON.stringify(res.data));
            dispatch((0,_store_wishlistData__WEBPACK_IMPORTED_MODULE_9__/* .fetchWishlist */ .BW)());
            if (redirect) {
                router.push("/");
            } else {
                if (res.data) {
            ...
            if (err.response) {
                if (err.response.data.notification === "Please verify your acount. If you didn't get OTP, please resend your OTP and verify") {
                    react_toastify__WEBPACK_IMPORTED_MODULE_4__.toast.warn(/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(SEND, {
                    ...
                    react_toastify__WEBPACK_IMPORTED_MODULE_4__.toast.error((0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.Invalid_Credentials);
                }
            } else {
                return false;
            }
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        axios__WEBPACK_IMPORTED_MODULE_11___default().get(`${"http://192.168.100.7:8001/"}api/login/google`).then((res)=>{
            if (res.data) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_11___default().get(`${"http://192.168.100.7:8001/"}api/login/facebook`).then((res)=>{
            if (res.data) {
                ...
                children: [
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                        ...
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_Helpers_InputCom__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z, {
                            placeholder: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.Email_or_Phone + " (+Country Code)",
                            label: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.Email_or_Phone + "*",
                            name: "email",
                            type: "text",
                            inputClasses: "h-[50px]",
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                        ...
                                        children: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.Remember_Me
                                    })
                                ]
                            }),
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_link__WEBPACK_IMPORTED_MODULE_2___default()), {
                                ...
                                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("a", {
                                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("span", {
                                        ...
                                        children: [
                                            (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.Forgot_password,
                                            "?"
                                        ]
                                    })
                                })
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                        ...
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                            ...
                            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("button", {
                                ...
                                children: [
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                        children: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.Login
                                    }),
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                        ...
                        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("p", {
                            ...
                            children: [
                                (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.Dontt_have_an_account,
                                " ?",
                                redirect ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_link__WEBPACK_IMPORTED_MODULE_2___default()), {
                                    ...
                                    children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                        ...
                                        children: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.sign_up_free
                                    })
                                }) : /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
