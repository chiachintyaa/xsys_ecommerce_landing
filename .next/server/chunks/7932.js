...
/* harmony import */ var _data_CountryCodes_json__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(7022);
...
function SignupWidget({ redirect =true , signupActionPopup , changeContent  }) {
    ...
    const { 0: fname , 1: setFname  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("");
    const { 0: lname , 1: setLname  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("");
    const { 0: email , 1: setEmail  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("");
    const { 0: phone , 1: setPhone  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("+880");
    const { 0: password , 1: setPassword  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("");
    const { 0: confirmPassword , 1: setConfirmPassword  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("");
    const { 0: checked , 1: setCheck  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
    const { 0: errors , 1: setErrors  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
    const { 0: loading , 1: setLoading  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
    const { 0: getCountries , 1: setGetCountries  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
    const { 0: countryDropToggle , 1: setCountryDropToggle  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
    const { 0: selectedCountry , 1: setSelectedCountry  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("BD");
    ...
    const { 0: twitterUrl , 1: setTwitterUrl  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        if (!getCountries) {
            setGetCountries(_data_CountryCodes_json__WEBPACK_IMPORTED_MODULE_9__ && _data_CountryCodes_json__WEBPACK_IMPORTED_MODULE_9__.countries);
        }
    }, [
        getCountries
    ]);
    ...
    const doSignup = async ()=>{
        setLoading(true);
        await _utils_apiRequest__WEBPACK_IMPORTED_MODULE_3__/* ["default"].signup */ .Z.signup({
            name: fname + " " + lname,
            email: email,
            password: password,
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        axios__WEBPACK_IMPORTED_MODULE_10___default().get(`${"http://192.168.100.7:8001/"}api/login/google`).then((res)=>{
            if (res.data) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_10___default().get(`${"http://192.168.100.7:8001/"}api/login/facebook`).then((res)=>{
            if (res.data) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_10___default().get(`${"http://192.168.100.7:8001/"}api/login/twitter`).then((res)=>{
            console.log(res);
            if (res.data) {
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                        ...
                        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                            ...
                            children: [
                                ...
                                redirect ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_link__WEBPACK_IMPORTED_MODULE_6___default()), {
...
function VerifyWidget({ redirect =true , verifyActionPopup  }) {
    ...
    const location = (0,next_router__WEBPACK_IMPORTED_MODULE_5__.useRouter)();
    const { 0: otp , 1: setOtp  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("");
    const { 0: errors , 1: setErrors  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
    const { 0: loading , 1: setLoading  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
